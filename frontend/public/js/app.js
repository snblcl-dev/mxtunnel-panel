...
(function () {
  ...
  // Mapeo tunnel_type (numerico) -> nombre en la app VpnApp. Tambien esta
  // disponible en el server-side (src/config/render-config.ts); aqui se expone
  // para el JS del navegador (formularios dinamicos, modales, etc.).
  window.TUNNEL_TYPES = {
    1: 'SSH + Payload',
    2: 'SSH + Proxy + Payload',
    3: 'SSH_SSL + SNI',
